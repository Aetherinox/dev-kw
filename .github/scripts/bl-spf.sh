...
#   @type               bash script
#   @summary            provide a domain name and fetch all of the ip addresses associated with that domain through _spf records.
#                       return a list of ipv4 and ipv6 addresses.
#   
#   @terminal           echo "yandex.ru" | .github/scripts/bl-spf.sh 02_privacy_yandex.ipset
#
#   @workflow           chmod +x ".github/scripts/bl-spf.sh"
#                       echo "yandex.ru" | .github/scripts/bl-spf.sh 02_privacy_yandex.ipset
#
#   @command            bl-spf.sh
#                           <ARG_SAVEFILE>
#
